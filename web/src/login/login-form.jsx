...
export function LoginForm({ onLoginSuccess, className, ...props }) {
  ...
  return (
    <div className={`login-form-wrapper ${className || ''}`} {...props}>
      <form className="login-form" onSubmit={handleSubmit}>
        ...
        <button className="login-submit" type="submit" disabled={isLoading}>
          {isLoading ? <span className="login-spinner" /> : <span>Login</span>}
        </button>
        ...
        <div className="login-socials">
          <button type="button" className="login-social-btn" onClick={() => handleSocialLogin('Apple')}>
