...
const SharePointLogo = () => (
  <svg viewBox="0 0 48 48" className="w-9 h-9">
    <circle cx="21" cy="20" r="11" fill="#008272" />
    <circle cx="29" cy="26" r="9" fill="#00A496" />
    <circle cx="19" cy="29" r="8" fill="#038387" />
  </svg>
);

const ConfluenceLogo = () => (
  <svg viewBox="0 0 48 48" className="w-9 h-9">
    <rect width="48" height="48" rx="14" fill="#0052CC" />
    <path fill="#FFF" d="M15 32a10 10 0 0115-15l3-4A15 15 0 0010 30l5 2z" />
    <path fill="#85B8FF" d="M33 16a10 10 0 01-15 15l-3 4A15 15 0 0038 18l-5-2z" />
  </svg>
);
...
const JiraLogo = () => (
  <svg viewBox="0 0 48 48" className="w-9 h-9">
    <rect width="48" height="48" rx="14" fill="#0052CC" />
    <path fill="#2684FF" d="M24 12l8 8-8 8-8-8 8-8z" />
    <path fill="#FFF" d="M24 20l8 8-8 8-8-8 8-8z" opacity="0.9" />
  </svg>
);

const ZendeskLogo = () => (
  <svg viewBox="0 0 48 48" className="w-9 h-9">
    <rect width="48" height="48" rx="14" fill="#03363D" />
    <circle cx="20" cy="24" r="5" fill="#15C39A" />
...
const OneDriveLogo = () => (
  <svg viewBox="0 0 48 48" className="w-9 h-9">
    <circle cx="24" cy="24" r="19" fill="#0078D4" />
    <path fill="#FFF" d="M33 29a6 6 0 00-3-11.5 9 9 0 00-17 3 7 7 0 007 8.5h13z" />
  </svg>
);

const DropboxLogo = () => (
  <svg viewBox="0 0 48 48" className="w-9 h-9">
    <rect width="48" height="48" rx="14" fill="#0061FF" />
    <path fill="#FFF" d="M16 17l8 5.5-8 5.5 8 5.5-8 5.5 8-5.5 8 5.5-8-5.5 8-5.5-8-5.5 8-5.5-8 5.5-8-5.5z" />
  </svg>
);
...
export default function AnimatedConnect01() {
  ...
  return (
    <div className="w-full min-h-[640px] bg-[#fbfbfa] py-20 px-4 sm:px-6 lg:px-8 flex flex-col items-center justify-center relative overflow-hidden font-sans">
      
      {/* Header Badge */}
      <div className="text-center max-w-2xl mx-auto mb-14">
        <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#f4f4f3] border border-[#e8e8e6] text-[#222] text-xs font-semibold mb-5 shadow-xs">
          <Sparkles className="w-3.5 h-3.5 text-[#555]" />
          <span>Animated Integration Pipeline</span>
        </div>
        <h2 className="text-4xl sm:text-5xl font-extrabold tracking-tight text-[#111] mb-3.5">
          Unify 15+ SaaS Tools into Your AI
        </h2>
        <p className="text-base text-[#666] leading-relaxed max-w-xl mx-auto">
      ...
      {/* Main Flow Container */}
      <div className="w-full max-w-3xl flex flex-col items-center relative pb-6">
          ...
          <svg className="w-full h-full overflow-visible" viewBox="0 0 600 400" fill="none">
            <defs>
              ...
              <style>{`
                ...
                .flow-dot-0 {
                  offset-path: path('M 60 40 L 60 250 C 60 320, 300 310, 300 395');
                  animation: pulseMove0 3.2s ease-in-out infinite;
                }
                .flow-dot-1 {
                  offset-path: path('M 180 40 L 180 250 C 180 320, 300 320, 300 395');
                  animation: pulseMove0 2.8s ease-in-out infinite 0.4s;
                }
                .flow-dot-2 {
                  offset-path: path('M 300 40 L 300 395');
                  animation: pulseMove0 2.4s ease-in-out infinite 0.8s;
                }
                .flow-dot-3 {
                  offset-path: path('M 420 40 L 420 250 C 420 320, 300 320, 300 395');
                  animation: pulseMove0 2.9s ease-in-out infinite 0.2s;
                }
                .flow-dot-4 {
                  offset-path: path('M 540 40 L 540 250 C 540 320, 300 310, 300 395');
            ...
            {[
              { id: 0, d: "M 60 40 L 60 250 C 60 320, 300 310, 300 395", dotClass: "flow-dot-0" },
              { id: 1, d: "M 180 40 L 180 250 C 180 320, 300 320, 300 395", dotClass: "flow-dot-1" },
              { id: 2, d: "M 300 40 L 300 395", dotClass: "flow-dot-2" },
              { id: 3, d: "M 420 40 L 420 250 C 420 320, 300 320, 300 395", dotClass: "flow-dot-3" },
              { id: 4, d: "M 540 40 L 540 250 C 540 320, 300 310, 300 395", dotClass: "flow-dot-4" },
            ].map((pathItem) => {
        ...
        <div className="grid grid-cols-5 gap-3.5 sm:gap-5 w-full z-10 justify-items-center mb-14">
          {cols.map((colApps, colIdx) => (
            <div key={colIdx} className="flex flex-col gap-3.5 sm:gap-5 items-center">
              {colApps.map((app) => {
                ...
                return (
                  <div
                    ...
                    className={`w-[78px] h-[78px] sm:w-[88px] sm:h-[88px] rounded-[24px] sm:rounded-[28px] border flex items-center justify-center p-3 cursor-pointer shadow-xs ${
                      isHovered
        ...
        <div className="w-full max-w-sm z-10 flex flex-col items-center pt-6">
          <div className="flex items-center justify-center gap-5 px-6 py-2.5 rounded-2xl bg-[#f4f4f3] border border-[#e5e5e3] shadow-xs">
            <div title="Vector Stack" className="hover:scale-110 transition-transform"><CubeLogo /></div>
            <div title="PostgreSQL" className="hover:scale-110 transition-transform"><PostgresLogo /></div>
            <div title="Redis / Layers" className="hover:scale-110 transition-transform"><LayersLogo /></div>
            <div title="MongoDB" className="hover:scale-110 transition-transform"><MongoLogo /></div>
            <div title="Integrations" className="hover:scale-110 transition-transform"><DoubleSlashLogo /></div>
          </div>
        </div>
